...
<header class="main-header">
    <div class="header-container">
        ...
        <nav class="nav-links" id="navLinks">
            ...
            <?php if ($isLoggedIn): ?>
                <a href="<?= htmlspecialchars($dashboardLink) ?>" class="btn-dashboard <?= navActive('dashboard',$currentPage) ?>"><i class="fas fa-user-circle"></i> Dashboard</a>
...
(function(){
    ...
    if(ham&&nav){ ham.addEventListener('click',function(){ ham.classList.toggle('open'); nav.classList.toggle('open'); }); nav.querySelectorAll('a').forEach(function(a){ a.addEventListener('click',function(){ ham.classList.remove('open'); nav.classList.remove('open'); }); }); }
})();
</script>
