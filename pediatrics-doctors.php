...
<section class="svc-hero">
    <div class="svc-hero-inner">
        <div class="svc-icon-hero"><i class="fas fa-child"></i></div>
        <h1>Paediatrics</h1>
        <p>Specialised, compassionate healthcare for infants, children, and adolescents.</p>
...
<div class="svc-body">
    ...
    <div class="svc-about">
        ...
        <p>Our Paediatrics unit provides a warm, child-friendly environment where our expert team cares for newborns through teenagers. From routine well-child visits to the management of complex chronic conditions, we partner with families every step of the way.</p>
    </div>
    ...
    <div class="svc-two-col">
        <div class="svc-list-card">
            ...
            <ul>
                    <li>Newborn &amp; Neonatal Care</li>
                    <li>Growth &amp; Development Assessments</li>
                    <li>Childhood Immunisations</li>
                    <li>Paediatric Respiratory Clinic</li>
                    <li>Child Nutrition &amp; Dietetics</li>
    ...
    <div class="svc-doctors-grid">
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Prof.+Shaman+Rajindrajith&size=150&background=3182ce&color=fff&bold=true&rounded=true" alt="Prof. Shaman Rajindrajith" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Prof. Shaman Rajindrajith</p>
                <p class="svc-doc-title">Consultant Pediatrician</p>
