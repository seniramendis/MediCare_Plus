<?php
$pageTitle = 'Orthopaedics | MediCare Plus';
if (session_status() === PHP_SESSION_NONE) session_start();
if (!isset($conn) && file_exists(__DIR__ . '/db_connect.php')) require_once __DIR__ . '/db_connect.php';
include 'header.php';
?>
<style>
:root { --svc-color: #dd6b20; --svc-bg: rgba(221,107,32,0.08); }
.svc-hero {
    position: relative;
    background: url('https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=1600&q=80') center/cover no-repeat;
...
<section class="svc-hero">
    <div class="svc-hero-inner">
        <div class="svc-icon-hero"><i class="fas fa-bone"></i></div>
        <h1>Orthopaedics</h1>
        <p>Expert bone, joint, and sports medicine care to keep you moving.</p>
...
<div class="svc-body">
    ...
    <div class="svc-about">
        ...
        <p>MediCare Plus Orthopaedics blends surgical excellence with evidence-based rehabilitation. Whether you need a joint replacement, sports injury management, or spine care, our specialists deliver outcomes that restore quality of life.</p>
    </div>
    ...
    <div class="svc-doctors-grid">
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Dr.+Ashan+Abeyewardene&size=150&background=dd6b20&color=fff&bold=true&rounded=true" alt="Dr. Ashan Abeyewardene" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Dr. Ashan Abeyewardene</p>
                <p class="svc-doc-title">Head of Joint Replacement</p>
