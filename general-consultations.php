<?php
$pageTitle = 'General Consultations | MediCare Plus';
if (session_status() === PHP_SESSION_NONE) session_start();
if (!isset($conn) && file_exists(__DIR__ . '/db_connect.php')) require_once __DIR__ . '/db_connect.php';
include 'header.php';
?>
<style>
:root { --svc-color: #2b6cb0; --svc-bg: rgba(43,108,176,0.08); }
.svc-hero {
    position: relative;
    background: url('https://images.unsplash.com/photo-1579684453423-f84349ef60b0?w=1600&q=80') center/cover no-repeat;
...
<section class="svc-hero">
    <div class="svc-hero-inner">
        <div class="svc-icon-hero"><i class="fas fa-stethoscope"></i></div>
        <h1>General Consultations</h1>
        <p>Your first point of trusted, comprehensive medical care.</p>
...
<div class="svc-body">
    ...
    <div class="svc-about">
        ...
        <p>Our General Practice team provides holistic, patient-centred care for individuals and families. Whether it is a routine check-up, a new health concern, or managing a chronic condition, our experienced GPs deliver thorough assessments and personalised management plans.</p>
    </div>
    ...
    <div class="svc-two-col">
        <div class="svc-list-card">
            ...
            <ul>
                    ...
                    <li>Prescription &amp; Medication Reviews</li>
                    <li>Travel Health &amp; Vaccinations</li>
    ...
    <div class="svc-doctors-grid">
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Dr.+Elena+Fernando&size=150&background=38a169&color=fff&bold=true&rounded=true" alt="Dr. Elena Fernando" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Dr. Elena Fernando</p>
                <p class="svc-doc-title">Senior General Practitioner</p>
