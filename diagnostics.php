<?php
$pageTitle = 'Diagnostics &amp; Imaging | MediCare Plus';
if (session_status() === PHP_SESSION_NONE) session_start();
if (!isset($conn) && file_exists(__DIR__ . '/db_connect.php')) require_once __DIR__ . '/db_connect.php';
include 'header.php';
?>
<style>
:root { --svc-color: #4a5568; --svc-bg: rgba(74,85,104,0.08); }
.svc-hero {
    position: relative;
    background: url('https://images.unsplash.com/photo-1583911559624-c547a6c8a13d?w=1600&q=80') center/cover no-repeat;
...
<section class="svc-hero">
    <div class="svc-hero-inner">
        <div class="svc-icon-hero"><i class="fas fa-microscope"></i></div>
        <h1>Diagnostics &amp; Imaging</h1>
        <p>State-of-the-art MRI, CT, laboratory, and imaging services for accurate diagnosis.</p>
...
<div class="svc-body">
    ...
    <div class="svc-about">
        ...
        <p>MediCare Plus Diagnostics is equipped with the latest imaging technology and a fully accredited laboratory. Our radiologists, pathologists, and diagnostic technicians work together to deliver fast, accurate results that guide your care team.</p>
    </div>
    ...
    <div class="svc-two-col">
        <div class="svc-list-card">
            ...
            <ul>
                    <li>MRI &amp; CT Scanning</li>
                    <li>X-Ray &amp; Ultrasound</li>
                    <li>Full Blood Panels</li>
                    <li>Histopathology</li>
                    <li>ECG &amp; Stress Testing</li>
                    <li>Bone Density (DEXA) Scans</li>
            </ul>
        </div>
        <div class="svc-list-card">
    ...
    <div class="svc-doctors-grid">
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Dr.+Priya+Mendis&size=150&background=4a5568&color=fff&bold=true&rounded=true" alt="Dr. Priya Mendis" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Dr. Priya Mendis</p>
                <p class="svc-doc-title">Consultant Radiologist</p>
                <a href="doctors.php" class="svc-doc-btn"><i class="fas fa-stethoscope"></i> See All Specialists</a>
            </div>
        </div>
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Dr.+Ravi+Sooriyarachchi&size=150&background=2d3748&color=fff&bold=true&rounded=true" alt="Dr. Ravi Sooriyarachchi" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Dr. Ravi Sooriyarachchi</p>
                <p class="svc-doc-title">Senior Pathologist</p>
                <a href="doctors.php" class="svc-doc-btn"><i class="fas fa-stethoscope"></i> See All Specialists</a>
            </div>
        </div>
    </div>
