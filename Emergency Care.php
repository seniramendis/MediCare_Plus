<?php
$pageTitle = 'Emergency Care | MediCare Plus';
if (session_status() === PHP_SESSION_NONE) session_start();
if (!isset($conn) && file_exists(__DIR__ . '/db_connect.php')) require_once __DIR__ . '/db_connect.php';
include 'header.php';
?>
<style>
:root { --svc-color: #e53e3e; --svc-bg: rgba(229,62,62,0.08); }
.svc-hero {
    position: relative;
    background: url('https://images.unsplash.com/photo-1612776572997-76cc42e058c3?w=1600&q=80') center/cover no-repeat;
...
<section class="svc-hero">
    <div class="svc-hero-inner">
        <div class="svc-icon-hero"><i class="fas fa-truck-medical"></i></div>
        <h1>Emergency Care</h1>
        <p>24/7 emergency and critical care — rapid response when every second counts.</p>
...
<div class="svc-body">
    ...
    <div class="svc-about">
        ...
        <p>Our Emergency Department is staffed around the clock by experienced emergency physicians, nurses, and support teams. With dedicated trauma bays, resuscitation rooms, and rapid diagnostic access, we deliver life-saving care at the highest standard.</p>
    </div>
    ...
    <div class="svc-two-col">
        <div class="svc-list-card">
            ...
            <ul>
                    <li>24/7 Emergency Walk-in</li>
                    <li>Trauma &amp; Critical Care</li>
                    <li>Ambulance Triage &amp; Reception</li>
                    <li>Rapid Diagnostic Lab</li>
                    <li>Emergency Surgical Support</li>
                    <li>Intensive Care (ICU) Transfer</li>
            </ul>
        </div>
        <div class="svc-list-card">
            <h3><i class="fas fa-notes-medical" style="color:var(--svc-color);margin-right:8px;"></i>Conditions We Treat</h3>
            <ul>
                    <li>Chest Pain &amp; Heart Attacks</li>
                    <li>Stroke</li>
                    <li>Severe Injuries &amp; Trauma</li>
    ...
    <div class="svc-doctors-grid">
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Dr.+Suresh+Bandara&size=150&background=e53e3e&color=fff&bold=true&rounded=true" alt="Dr. Suresh Bandara" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Dr. Suresh Bandara</p>
                <p class="svc-doc-title">Head of Emergency Medicine</p>
                <a href="doctors.php" class="svc-doc-btn"><i class="fas fa-stethoscope"></i> See All Specialists</a>
            </div>
        </div>
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Dr.+Kumari+Wijeratne&size=150&background=c53030&color=fff&bold=true&rounded=true" alt="Dr. Kumari Wijeratne" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Dr. Kumari Wijeratne</p>
                <p class="svc-doc-title">Consultant Emergency Physician</p>
                <a href="doctors.php" class="svc-doc-btn"><i class="fas fa-stethoscope"></i> See All Specialists</a>
            </div>
        </div>
    </div>
