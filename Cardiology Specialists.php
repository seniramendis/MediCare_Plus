<?php
$pageTitle = 'Cardiology Specialists | MediCare Plus';
...
.svc-hero {
    position: relative;
    background: url('https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=1600&q=80') center/cover no-repeat;
...
<section class="svc-hero">
    <div class="svc-hero-inner">
        <div class="svc-icon-hero"><i class="fas fa-heart-pulse"></i></div>
        <h1>Cardiology Specialists</h1>
        <p>World-class cardiac care — from diagnostics to complex interventional procedures.</p>
...
<div class="svc-body">
    ...
    <div class="svc-about">
        ...
        <p>Our Cardiology department offers comprehensive heart care delivered by Sri Lanka's leading cardiologists. We combine cutting-edge technology with personalised treatment plans to manage everything from hypertension and arrhythmias to complex coronary artery disease.</p>
    </div>
    ...
    <div class="svc-doctors-grid">
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Dr.+Gotabhaya+Ranasinghe&size=150&background=e53e3e&color=fff&bold=true&rounded=true" alt="Dr. Gotabhaya Ranasinghe" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Dr. Gotabhaya Ranasinghe</p>
                <p class="svc-doc-title">Senior Consultant Cardiologist</p>
                <a href="doctors.php" class="svc-doc-btn"><i class="fas fa-stethoscope"></i> See All Specialists</a>
            </div>
        </div>
        <div class="svc-doc-card">
            <img src="https://ui-avatars.com/api/?name=Dr.+Chandra+Silva&size=150&background=6b46c1&color=fff&bold=true&rounded=true" alt="Dr. Chandra Silva" class="svc-doc-avatar">
            <div>
                <p class="svc-doc-name">Dr. Chandra Silva</p>
                <p class="svc-doc-title">Consultant Cardiologist</p>
                <a href="doctors.php" class="svc-doc-btn"><i class="fas fa-stethoscope"></i> See All Specialists</a>
            </div>
        </div>
    </div>
